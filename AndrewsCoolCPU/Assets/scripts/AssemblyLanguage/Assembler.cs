...
public class Assembler
{
    ...
    public void AssembleProgram(ref Program program) {
        ...
        if(program.assembled) {
            ConsoleControl.CONSOLE.LogMessage("Program sucessfully assembled");
        }
    }
        ...
        foreach(LineOfCode line in codeBase) {
            ...
            switch (line.command) {
                ...
                case ("JMP"):
                    ...
                    break;
                case ("BCC"):
                    line.data = CreateBCCComand(ref program, line);
                    break;
                case ("BCS"):
                    line.data = CreateBCSComand(ref program, line);
                    break;
                case ("BPL"):
                    line.data = CreateBPLComand(ref program, line);
                    break;
                case ("BMI"):
                    line.data = CreateBMIComand(ref program, line);
                    break;
                case ("BEQ"):
                    line.data = CreateBEQComand(ref program, line);
                    break;
                case ("BNE"):
                    line.data = CreateBNEComand(ref program, line);
                    break;
                case ("BVC"):
                    line.data = CreateBVCComand(ref program, line);
                    break;
                case ("BVS"):
                    line.data = CreateBVSComand(ref program, line);
                    break;
            }
    ...
    /**
     * @brief Translates a given line of code into a 'BCC' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBCCComand(ref Program program, LineOfCode lineOfCode) {
        //BCCs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BCS' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBCSComand(ref Program program, LineOfCode lineOfCode)
    {
        //BCSs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BPL' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBPLComand(ref Program program, LineOfCode lineOfCode)
    {
        //BPLs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BMI' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBMIComand(ref Program program, LineOfCode lineOfCode)
    {
        //BMIs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BNE' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBNEComand(ref Program program, LineOfCode lineOfCode)
    {
        //BNEs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BEQ' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBEQComand(ref Program program, LineOfCode lineOfCode)
    {
        //BEQs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BVC' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBVCComand(ref Program program, LineOfCode lineOfCode)
    {
        //BVCs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
    ...
    /**
     * @brief Translates a given line of code into a 'BVS' command.
     * @param program       - A reference to the program being assembled.
     * @param lineOfCode    - The line of code being translated.
     */
    private string CreateBVSComand(ref Program program, LineOfCode lineOfCode)
    {
        //BVSs can only have one parameter.
        if (WrongNumberOfParameters(ref program, 1, lineOfCode)) { return ""; }
